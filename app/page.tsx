...
export default function AIBusinessLaunchPage() {
  ...
  const features = [
    {
      num: "01",
      title: "The Visual System Map (PDF)",
      desc: "A visual 1-page architecture breakdown of your entire zero-maintenance funnel from traffic to automated fulfillment.",
    },
    {
      num: "02",
      title: "Founder Command Centre & AI Prompts",
      desc: "Production-grade system prompts calibrated for Gemini, Claude, and ChatGPT to lock in positioning and offers in 20 minutes.",
    },
    {
      num: "03",
      title: "High-Converting Page Blueprint & Copy Engine",
      desc: "The wireframe framework and section-by-section formulas to write sales copy without paying an agency.",
    },
    {
      num: "04",
      title: "Plug-and-Play Checkout & Automated Fulfillment Engine",
      desc: "Zero-maintenance Paystack checkout setup with instant Google Drive asset delivery and webhook automation.",
    },
    {
      num: "05",
      title: "24/7 AI Sales & Support Agent Architecture",
      desc: "Deployable conversational agent scripts to embed directly on your frontend to handle objections and drive conversions.",
    },
  ];
  ...
  const executionSteps = [
    {
      ...
      title: "Unpack Your Core Offer",
      desc: "Load the Founder Command Centre prompts into your AI tool to generate your target profile, core proposition, and marketing angles.",
    },
    {
      step: "02",
      time: "Saturday Afternoon",
      title: "Assemble Your Sales Engine",
      desc: "Drop your generated copy into our wireframe layout and connect your payment page.",
    },
    {
      step: "03",
      time: "Sunday Morning",
      title: "Deploy Automated Fulfillment",
      desc: "Paste the included script into Google Sheets, connect your Paystack webhook, and run a live test.",
    },
  ];
  ...
  return (
    <>
      <Head>
        <title>48-Hour Startup Launch Kit — Renovate Africa</title>
        <meta name="description" content="Launch Your Digital Business Online in 48 Hours — Without Writing Code or Hiring an Agency. The complete rapid launch architecture kit." />
      ...
      <style jsx global>{`
        ...
        @media (min-width: 769px) {
          .ra-feat:last-child:nth-child(odd) {
            grid-column: span 2;
          }
        }
        ...
        @media (max-width: 768px) {
          ...
          .ra-steps-grid { grid-template-columns: 1fr; }
          .ra-hero-cta-group { flex-direction: column; align-items: stretch; }
          .ra-hero-cta-group .ra-cta-btn, .ra-hero-cta-group .ra-cta-btn-secondary { justify-content: center; text-align: center; }
      ...
      <div className="ra-page">
        ...
        <section className="ra-hero">
          <nav className="ra-nav">
            ...
            <div className="ra-nav-links">
              <a href="#system">System Stack</a>
              <a href="#execution">48-Hour Plan</a>
              <a href="#team">Our Story</a>
              <a href="#faq">FAQ</a>
              <a href="https://paystack.shop/pay/vn0s8y05bm" className="ra-nav-cta">Get Instant Access</a>
            </div>
          </nav>

          <div className="ra-hero-grid">
            <div className="ra-hero-left">
              <span className="ra-label">RAPID LAUNCH ARCHITECTURE</span>
              <h1>
                Launch Your Digital Business Online in <span className="accent">48 Hours</span> — Without Writing Code or Hiring an Agency.
              </h1>
              <p className="sub">
                Stop losing weeks to fragmented tools. Get the complete execution kit: production-ready AI system prompts, high-converting landing page wireframes, and a zero-maintenance checkout-to-fulfillment engine that runs 24/7.
              </p>
              ...
              <div className="ra-hero-cta-group">
                <a href="https://paystack.shop/pay/vn0s8y05bm" className="ra-cta-btn">
                  {p.btn} →
                </a>
                <a href="#execution" className="ra-cta-btn-secondary">
                  View 48-Hour Plan ↓
                </a>
              </div>
            </div>
          ...
          <div className="ra-hero-bottom-bar">
            Instant Google Drive Delivery • Zero Monthly Subscriptions • One-Time Payment
          </div>
        </section>
        ...
        {/* ===== SYSTEM STACK / DELIVERABLES — DARK TEAL ===== */}
        <section className="ra-section-teal" id="system">
          <div className="ra-inner">
            <div className="ra-sec-header">
              <span className="ra-label">03 — System Stack & Deliverables</span>
              <h2>The 5 Core Modules of the <span className="accent">Launch Kit</span></h2>
              <p className="sec-sub">Replace weeks of fragmented tools and agency delays with 5 production-grade modules designed for immediate deployment.</p>
            </div>
            ...
            <div className="ra-stack-bar">
              {["Next.js 14", "TypeScript", "Tailwind CSS", "Paystack", "Stripe", "Google Sheets API", "Gemini 2.0", "Claude 3.5", "Vercel", "Google Drive Delivery"].map((t) => (
        ...
        {/* ===== 3-STEP EXECUTION SECTION — CREAM ===== */}
        <section className="ra-section-cream" id="execution">
          <div className="ra-inner">
            <div className="ra-sec-header">
              <span className="ra-label ra-label-dark">04 — 3-Step Execution</span>
              <h2>Your 48-Hour Weekend <span className="accent">Launch Roadmap</span></h2>
              <p className="sec-sub">From unpack to live test — execute this exact sequence to deploy your digital business.</p>
            </div>
            <div className="ra-steps-grid">
              {executionSteps.map((s, i) => (
                <div className="ra-step-card" key={i}>
                  <div className="ra-step-meta">
                    <span className="ra-step-time">{s.time}</span>
                    <span className="ra-step-num">{s.step}</span>
                  </div>
                  <h3>{s.title}</h3>
                  <p>{s.desc}</p>
                </div>
        ...
        <section className="ra-section-cream" id="team" style={{ padding: '100px 24px' }}>
          <div className="ra-team-grid">
            ...
            <div className="ra-team-text">
              <span className="ra-label ra-label-dark" style={{ marginBottom: 16, display: 'block' }}>05 — Our Story</span>
              <h2>
        ...
        <section className="ra-section-teal" style={{ padding: '100px 24px' }}>
          <div className="ra-inner">
            <div className="ra-sec-header" style={{ textAlign: 'center' }}>
              <span className="ra-label">06 — Proof</span>
        ...
        <section className="ra-section-cream" id="faq">
          <div className="ra-inner">
            <div className="ra-sec-header">
              <span className="ra-label ra-label-dark">07 — Questions</span>
        ...
        <section className="ra-final" id="checkout">
          <div className="ra-inner">
            <span className="ra-label" style={{ marginBottom: 20, display: 'block' }}>08 — Decision</span>
            <h2>
            ...
            <div className="ra-guarantee">
              <span>🛡️</span>
              <span>Instant Google Drive Delivery • Zero Monthly Subscriptions • One-Time Payment</span>
            </div>
          </div>
        </section>
